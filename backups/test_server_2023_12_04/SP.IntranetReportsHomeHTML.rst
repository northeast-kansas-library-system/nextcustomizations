  ...
  <div class="mptabContent" id="tabR04">
    ...
    <div>
      <div id="stat1">
        ...
        <div id="circulation_by_library_details" style="display: none;">
        ...
        <div id="circulation_by_item_details">
          ...
          <div>
            ...
            <p>We began keeping this data in this format in 2019</p>
            <p>-----</p>
          </div>
        </div>

        <div id="circulation_by_borrower_details" style="display: none;">
        ...
        <div id="borrower_statistics" style="display: none;">
